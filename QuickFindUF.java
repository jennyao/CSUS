...
public class QuickFindUF {
    ...
    public static void main(String[] args) {
        ...
        Stopwatch timer = new Stopwatch();    //new addition from p.175
        while (!StdIn.isEmpty()) {
            int p = StdIn.readInt();
            int q = StdIn.readInt();
        ...
        double time = timer.elapsedTime();    //new addition from p.175
        StdOut.println(uf.count() + " components");
        System.out.println("Stopwatch: " + time);      //new addition
    }
